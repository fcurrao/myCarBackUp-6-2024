import { Image, Text, Pressable, StyleSheet , ScrollView, View } from "react-native";
...
const MyProfile = ({navigation}) => {
    ...
    // const [email, setEmail] = useState("lalalalala@gmail.com")
    // const [localId, setLocalId] = useState("lalalalala@gmail.com")
    // const [profileImage, setProfileImage] = useState("lalalalala@gmail.com")
...
const onSignout = async () => {
    try{
        if ( localId){
            ...
            const response = await deleteSession("fEYZxGcydFP76EImhlGXgJxfV8v1")
        console.log("session deleted:")
        console.log(response)
        }
    }
    ...
    return (
        ...
        <View style={styles.container}>
            <Text style={styles.perfil}>  {email.split("@")[0] || "Usuario" }  </Text>
           ...
           <Pressable style={styles.button}  onPress={onSignout} title="Guardar Locacion Rapida..." >  
           <AntDesign  name="down"  size={22} color={colors.colorgris}/>
            <Text style={styles.textb}>Guardar Locacion Rapida...</Text>
            </Pressable>
            </View> 
        </View>
            </ScrollView>
